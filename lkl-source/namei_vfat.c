				  ...
				  unsigned int flags)
{
	...
	struct dentry *alias;
	int err;
	printk(KERN_INFO "###fs/fat/namei_vfat.c - INSIDE VFAT_LOOKUP###");
		       ...
		       bool excl)
{
	...
	struct timespec ts;
	int err;
	printk(KERN_INFO "###fs/fat/namei_vfat.c - INSIDE VFAT_CREATE###");
...
static int vfat_rmdir(struct inode *dir, struct dentry *dentry)
{
	...
	struct fat_slot_info sinfo;
	int err;
	printk(KERN_INFO "###fs/fat/namei_vfat.c - INSIDE VFAT_RMDIR###");
...
static int vfat_unlink(struct inode *dir, struct dentry *dentry)
{
	...
	struct fat_slot_info sinfo;
	int err;
	printk(KERN_INFO "###fs/fat/namei_vfat.c - INSIDE VFAT_UNLINK###");
...
static int vfat_mkdir(struct inode *dir, struct dentry *dentry, umode_t mode)
{
	...
	struct timespec ts;
	int err, cluster;
	printk(KERN_INFO "###fs/fat/namei_vfat.c - INSIDE VFAT_MKDIR###");
		       ...
		       unsigned int flags)
{
	...
	printk(KERN_INFO "###fs/fat/namei_vfat.c - INSIDE VFAT_RENAME###");
