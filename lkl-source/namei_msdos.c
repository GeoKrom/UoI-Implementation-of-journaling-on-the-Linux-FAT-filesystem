				   ...
				   unsigned int flags)
{
	...
	struct inode *inode;
	int err;
	printk(KERN_INFO "###fs/fat/namei_msdos.c - INSIDE MSDOS_LOOKUP###");
			...
			bool excl)
{
	...
	unsigned char msdos_name[MSDOS_NAME];
	int err, is_hid;
	printk(KERN_INFO "###fs/fat/namei_msdos.c - INSIDE MSDOS_CREATE###");
...
static int msdos_rmdir(struct inode *dir, struct dentry *dentry)
{
	...
	struct fat_slot_info sinfo;
	int err;
	printk(KERN_INFO "###fs/fat/namei_msdos.c - INSIDE MSDOS_REDIR###");
...
static int msdos_mkdir(struct inode *dir, struct dentry *dentry, umode_t mode)
{
	...
	printk(KERN_INFO "###fs/fat/namei_msdos.c - INSIDE MSDOS_MKDIR###");
...
static int msdos_unlink(struct inode *dir, struct dentry *dentry)
{
	...
	struct fat_slot_info sinfo;
	int err;
	printk(KERN_INFO "###fs/fat/namei_msdos.c - INSIDE MSDOS_UNLINK###");
			...
			unsigned int flags)
{
	...
	int err, is_hid;
	printk(KERN_INFO "###fs/fat/namei_msdos.c - INSIDE MSDOS_RENAME###");
